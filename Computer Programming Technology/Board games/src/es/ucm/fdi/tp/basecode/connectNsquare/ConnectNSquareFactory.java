...
public class ConnectNSquareFactory implements GameFactory {

	private int dim;

	public ConnectNSquareFactory() {
		this(5);
	}

	public ConnectNSquareFactory(int dim) {
		if (dim < 3) {
	...
	public GameRules gameRules() {
		return new ConnectNSquareRules(dim);
	}

	@Override
	public Player createConsolePlayer() {
		ArrayList<GameMove> possibleMoves = new ArrayList<GameMove>();
		possibleMoves.add(new ConnectNSquareMove());
		return new ConsolePlayer(new Scanner(System.in), possibleMoves);
	}

	@Override
	public Player createRandomPlayer() {
		return new ConnectNSquareRandomPlayer();
	}
