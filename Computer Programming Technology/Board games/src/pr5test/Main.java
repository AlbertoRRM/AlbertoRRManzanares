...
public class Main {
	 ...
	 */
	enum GameInfo {
		CONNECTN("cn", "ConnectN"), ConnectNSquare("cns", "ConnectNSquare"), TicTacToe("ttt", "Tic-Tac-Toe"), AdvancedTicTacToe("attt", "Advanced Tic-Tac-Toe"),
		Ataxx("atx", "Ataxx");
	...
	private static Option constructObstacleOption() {
		return new Option("o", "obstacle", true,
				"The number of obstacles that will appear in each quadrant.");
	}
	...
	public static void startGame() {
		...
		case CONSOLE:
			...
			new BoardExample(g, new Controller(g,pieces));
			//gameFactory.createSwingView(g, c, pieces, null, null);
			break;
		case WINDOW:
			throw new UnsupportedOperationException(
