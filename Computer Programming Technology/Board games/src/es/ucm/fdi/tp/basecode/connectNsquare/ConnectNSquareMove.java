 ...
 * 
 */
public class ConnectNSquareMove extends GameMove {
	 ...
	 * {@link ConnectNSquareMove} to generate game moves from strings by calling
	 * {@link #fromString(String)}
	 * 
	 * <p>
	 * Solo se debe usar este constructor para obtener objetos de
	 * {@link ConnectNSquareMove} para generar movimientos a partir de strings usando
	 * el metodo {@link #fromString(String)}
	 * 
	 */

	public ConnectNSquareMove() {
	}
	 ...
	 */
	public ConnectNSquareMove(int row, int col, Piece p) {
		super(p);
		this.row = row;
		this.col = col;
	}
	...
	protected GameMove createMove(int row, int col, Piece p) {
		return new ConnectNSquareMove(row, col, p);
	}
